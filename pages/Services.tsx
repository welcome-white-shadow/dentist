          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {services.map((service) => (
              <div key={service.id} className="bg-white rounded-[3rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all border border-slate-100 flex flex-col md:flex-row group">
                <div className="md:w-1/3 relative overflow-hidden group-hover:scale-105 transition-transform duration-700 h-64 md:h-auto">
                  <img 
                    src={
                      service.id === 'general-dentistry' ? 'https://images.pexels.com/photos/3845806/pexels-photo-3845806.jpeg?auto=compress&cs=tinysrgb&w=800' :
                      service.id === 'root-canal' ? 'https://images.pexels.com/photos/3845810/pexels-photo-3845810.jpeg?auto=compress&cs=tinysrgb&w=800' :
                      service.id === 'teeth-whitening' ? 'https://images.pexels.com/photos/3845759/pexels-photo-3845759.jpeg?auto=compress&cs=tinysrgb&w=800' :
                      service.id === 'dental-implants' ? 'https://images.pexels.com/photos/3845722/pexels-photo-3845722.jpeg?auto=compress&cs=tinysrgb&w=800' :
                      service.id === 'braces-aligners' ? 'https://images.pexels.com/photos/4269493/pexels-photo-4269493.jpeg?auto=compress&cs=tinysrgb&w=800' :
                      service.id === 'pediatric-dentistry' ? 'https://images.pexels.com/photos/3845811/pexels-photo-3845811.jpeg?auto=compress&cs=tinysrgb&w=800' :
                      'https://images.pexels.com/photos/3845806/pexels-photo-3845806.jpeg?auto=compress&cs=tinysrgb&w=800'
                    } 
                    alt={service.title} 
                    className="w-full h-full object-cover" 
                  />
                  <div className="absolute inset-0 bg-teal-900/10 group-hover:bg-teal-900/0 transition-all"></div>
                  <div className="absolute top-6 left-6 w-12 h-12 bg-white/90 backdrop-blur rounded-xl flex items-center justify-center text-teal-600 shadow-lg">
